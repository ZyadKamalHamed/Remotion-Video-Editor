...
export const ccLoopSpinDiagonalSchema = z.object({
  ...
  /** Tilt angle for diagonal axis (degrees) */
  tiltAngle: z.number().default(15),
});

export type CCLoopSpinDiagonalProps = z.infer<typeof ccLoopSpinDiagonalSchema>;

export const defaultCCLoopSpinDiagonalProps: CCLoopSpinDiagonalProps = {
