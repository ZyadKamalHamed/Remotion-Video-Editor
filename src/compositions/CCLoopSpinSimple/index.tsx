...
import { CCLoopSpinSimpleProps } from "./schema";

/**
 * CCLoopSpinSimple - Simple version with 180° offset, no 3D depth
 *
 ...
 */
export const CCLoopSpinSimple: React.FC<CCLoopSpinSimpleProps> = ({
  backgroundSrc,
  loopASrc,
  loopBSrc,
  spinSpeed,
...
export default CCLoopSpinSimple;
