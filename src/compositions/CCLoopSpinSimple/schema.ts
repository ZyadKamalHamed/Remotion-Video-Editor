...
export const ccLoopSpinSimpleSchema = z.object({
...
export type CCLoopSpinSimpleProps = z.infer<typeof ccLoopSpinSimpleSchema>;

export const defaultCCLoopSpinSimpleProps: CCLoopSpinSimpleProps = {
